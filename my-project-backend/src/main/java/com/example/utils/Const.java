...
public final class Const {
    ...
    public final static String ROLE_MANAGE = "admin";
    //论坛相关
    ...
    public final static String JUDGE_TOPIC_PREVIEW_CACHE = "judge:topic:preview:";
    //论坛评论创建
    public final static String FORUM_COMMENT_CREATE_COUNTER = "topic:comment:create";
